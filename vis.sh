...
git log --pretty=format:'[%h] %an %ad %s' --date=short \
	...
	maat -l /home/result/hib_evo.log -c git -a revisions > /home/result/maat_freqs.csv
	
cd /home/result && \
python3 /app/maat-scripts/transform/csv_as_enclosure_json.py --structure ./maat_lines.csv --weights ./maat_freqs.csv > output.csv
cp home/visualization/* -r /home/output 
